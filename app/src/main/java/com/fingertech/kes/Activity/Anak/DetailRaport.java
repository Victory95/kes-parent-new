...
public class DetailRaport extends AppCompatActivity {
    ...
    JSONObject jsonObject,type_exam,innerJsonObject,statusobject,codeobject;
    ...
    String typename,score_exam,praktikum,eskul,ujian_sekolah,ujian_negara,mapel,nilai_akhir,rata_rata;
