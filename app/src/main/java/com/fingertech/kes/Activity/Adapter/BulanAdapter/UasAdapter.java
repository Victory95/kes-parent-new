...
public class UasAdapter extends RecyclerView.Adapter<UasAdapter.MyHolder> {
    ...
    private List<ModelUas> viewItemList;
    private List<ModelUas> itemUjianList;
    ...
    public UasAdapter(List<ModelUas> viewItemList,Context context) {
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        ...
        ModelUas viewItem = viewItemList.get(position);
        // Set car item title.
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<ModelUas> filteredList = new ArrayList<>();

                    for (ModelUas androidVersion : itemUjianList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                viewItemList = (ArrayList<ModelUas>) filterResults.values;
